...
var MentionUserRegex = regexp.MustCompile(`^<@(?P<Identifier>[0-9]{1,20})>$`)
var MentionUserNicknameRegex = regexp.MustCompile(`^<@!(?P<Identifier>[0-9]{1,20})>$`)
var MentionChannelRegex = regexp.MustCompile(`^<#(?P<Identifier>[0-9]{1,20})>$`)
var MentionRoleRegex = regexp.MustCompile(`^<@&(?P<Identifier>[0-9]{1,20})>$`)
var MentionCustomEmojiRegex = regexp.MustCompile(`^<:(?P<EmojiName>\w+):(?P<Identifier>[0-9]{1,20})>$`)
var MentionCustomEmojiAnimatedRegex = regexp.MustCompile(`^<a:(?P<EmojiName>\w+):(?P<Identifier>[0-9]{1,20})>$`)
